...
export const ElephantsPage = () => {
    ...
    const shortText = () => {
        return (
            <>
                <p>
                    «Слоны» - очаровательные существа, покорившие сердца людей
                    во всем мире, как своим величественным внешним видом, так и
                    своим духовным значением. Во многих культурах слоны являются
                    священным животным и символизируют счастье, успех,
                    долголетие и мудрость.
                </p>
                <p>
    ...
    const longText = () => {
        return (
            <>
                ...
                <p>
                    Так, например, слоны в Азиатском мире считаются
                    божественными животными, сильными и выносливыми, наделенными
                    терпением и умом. Они по праву носят титул царственного
                    животного.
                </p>
                <p>
                    В Китае слон считается символом здоровья и долголетия, он
                    символизирует духовные знания и служит символом гармонии. В
                    буддистских текстах сказано, что белый слон поможет
                    освободится людям от земных оков.
                </p>
                <p>
                    В Таиланде слонам поклоняются как могущественному и мудрому
                    животному, который защищает от злых духов. Местная
                    архитектура практически у каждого здания имеет алтарь со
                    статуэтками божеств, на которых в обязательном порядке
                    присутствуют слоны.
                </p>
                <p>
                    В Индии слон - это царь зверей, символ благоразумия и
                    мудрости.
                </p>
                <p>
                    В Христианстве слоны так же обнаружили себя, слон
                    символизирует победу Христа над злом, и изображен он как
                    растаптывающий змею.
                </p>
                <p>
                    Считается, что символы слона в доме создают прочный
                    фундамент для устойчивого образа жизни, устраняют конфликты
                    и проблемы, оказывают поддержку и процветание, приносят тягу
                    к духовному развитию и проявлению мудрости.
                </p>
                <p>
                    Именно поэтому многие люди предпочитают иметь у себя дома
                    хотя бы один символ этого величественного животного в виде
                    картины или статуэтки.
                </p>
                <p>
                    Не обошел стороной этот символ и великого испанского
                    живописца, писателя, режиссера и скульптора Сальвадора Дали.
                    Если рассматривать его произведения, то слоны стали одним из
                    его самых узнаваемых символов. Наверняка вам знакомы
                    длинные, тонкие ноги слонов, несущих на себе таинственные
                    объекты. Для Дали слоны стали не просто животными, а
                    символом – будущего, воплощением бессмертия и мистицизма.
                </p>
                <p>
                    Для самого Дали, помимо символизма, слоны имели практическую
                    значимость. Так, например, в некоторых его работах они несут
                    на спинах гигантские столбы, мягкие часы или замки. Эти
                    слоны, казалось бы, играют роль несущих обрядовые предметы,
                    метафорически обозначая вечность. В творчестве Дали слоны,
                    являются не просто изображением животного, а особым
                    символом, который помогает художнику транслировать свои
                    мысли о времени, памяти и бессмертие.
                </p>
                <p>
                    Вот и меня не обошел его мифический образ стороной. Конечно,
                    выполняя скульптуры по мотивам таких картин, каждый творец
                    видит и берет для себя именно те образы и исполнения,
                    которые наиболее близки ему. Эти чудесные слоники просто
                    покорили мое сердце, наслаждаясь процессом создания, я не
                    замечаю течения времени. Каждый слоник, выполненный с
                    любовью и теплом моих рук, уже нашел себе дом, радуя своего
                    владельца. Слоники приятно удивляют своих хозяев не только
                    своим исполнением, но и магическими свойствами, они
                    действительно помогают с легкостью длинных ног перешагивать
                    все невзгоды, оставаясь всегда на высоте. Я верю, что это
                    все благодаря положительной энергетике, с которой я выполняю
                    каждого любимца.{' '}
