            ...
            <Container>
                ...
                >
                    ...
                    >
                        ...
                        <p className={s.content}>
                            «Слоны» - очаровательные существа, покорившие сердца
                            людей во всем мире, как своим величественным внешним
                            видом, так и своим духовным значением. Во многих
                            культурах слоны являются...
                        </p>
                        <button
                            className={s.button}
                ...
                >
                    ...
                    >
                        ...
                        <p className={s.content}>
                            Все искусство Сальвадора Дали пронизано скрытыми
                            смыслами, шифрами и кодами, которые можно
                            разгадывать бесконечно, хотя многие считают, что это
                            всего лишь...
                        </p>
                        <button
                            className={s.button}
                ...
                >
                    ...
                    >
                        ...
                        <p className={s.content}>
                            ...
                            дети России", также была вручена медаль. И только
                            теперь...
                        </p>
                        <button
                            className={s.button}
