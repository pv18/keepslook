    ...
    return (
      <>
        ...
        <p>
          ...
          животными, сильными и выносливыми, наделенными терпением и умом. Они по
        ...
        <p>
          ...
          значимость. Так, например, в некоторых его работах они несут на
          спинах гигантские столбы, мягкие часы или замки. Эти слоны, казалось
          бы, играют роль несущих обрядовые предметы, метафорически обозначая
          вечность. В творчестве Дали слоны, являются не просто
          изображением животного, а особым символом, который помогает художнику
          транслировать свои мысли о времени, памяти и бессмертие.
        </p>
        <p>
